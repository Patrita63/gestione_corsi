...
const EditTipoUtente: FC<EditTipoUtenteProps> = () => {
    ...
    const callUpdateTipoUtente = async (id: number) => {
    ...
    return (
        ...
        <Container maxWidth="xs">
            ...
            >
                ...
                <Typography variant="h6">Data of TipoUtente with ID={TipoUtenteId} (Update)</Typography>
                <Box sx={{ mt: 3 }}>
                <Grid container spacing={2}>
                    ...
                    <Button
                        ...
                        variant="contained"
                        sx={{ mt: 3, mb: 2 }}
                        onClick={() => callUpdateTipoUtente(TipoUtenteId)}
                    >
                        Update
                    </Button>
                    <Button
